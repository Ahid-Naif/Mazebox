...
byte addr_rom2[2][8] = {{1, 65, 42, 68, 0, 122, 0, 133},
  {1, 103, 202, 25, 0, 122, 0, 30}
};
byte addr_rom3[2][8] = {{1, 118, 153, 60, 0, 122, 0, 88},
  {1, 89, 145, 69, 0, 122, 0, 207}
};
byte addr_rom4[2][8] = {{1, 46, 188, 55, 0, 122, 0, 105},
  {1, 81, 150, 69, 0, 122, 0, 63}
};
byte addr_rom5[2][8] = {{1, 176, 83, 68, 0, 122, 0, 94},
  {1, 72, 155, 69, 0, 122, 0, 30}
};




//22:41:04.050 -> ROM1 = 1, 171, 67, 69, 0, 122, 0, 14, 
//22:41:04.084 -> 4
//22:41:04.084 -> ROM2 = 1, 103, 202, 25, 0, 122, 0, 30, 
//22:41:04.121 -> 4
//22:41:04.121 -> ROM3 = 1, 89, 145, 69, 0, 122, 0, 207, 
//22:41:04.192 -> 4
//22:41:04.192 -> ROM4 = 1, 81, 150, 69, 0, 122, 0, 63, 
//22:41:04.226 -> 0
//22:41:04.226 -> ROM5 = 1, 72, 155, 69, 0, 122, 0, 30, 
//22:41:04.050 -> ROM1 = 1, 171, 67, 69, 0, 122, 0, 14, 
//22:41:04.084 -> 4
//22:41:04.084 -> ROM2 = 1, 103, 202, 25, 0, 122, 0, 30, 
//22:41:04.121 -> 4
...
void loop() {
  ...
  if (ds1.reset()) {
    ...
    if (debug) Serial.println(count1);
  ...
  if (ds4.reset()) {
    ...
    if (debug) Serial.println();
    if (debug) Serial.println(count4);
  ...
  if (temp1 > 3) digitalWrite(out1, 0);
  if (temp1 < 2) digitalWrite(out1, 1);

  if (temp2 > 3) digitalWrite(out2, 0);
  if (temp2 < 2) digitalWrite(out2, 1);

  if (temp3 > 3) digitalWrite(out3, 0);
  if (temp3 < 2) digitalWrite(out3, 1);

  if (temp4 > 3) digitalWrite(out4, 0);
  if (temp4 < 2) digitalWrite(out4, 1);

  if (temp5 > 3) digitalWrite(out5, 0);
  if (temp5 < 2) digitalWrite(out5, 1);

  if (flag_end == 1) {
    if (temp1 < 2 && temp2 < 2 && temp3 < 2 && temp4 < 2 && temp5 < 2) {
      flag_end = 0;
  ...
  if (flag_end == 0) {
    for (int i = 0; i < 6; i++) {
      if (temp1 > 3) {
        ...
        for (int k = 0; k < NUMPIXELS1; k++) strip1.setPixelColor(k, 0, 0, 0);
      }
      strip1.show();
      ...
      if (temp2 > 3) {
        ...
        for (int k = 0; k < NUMPIXELS1; k++) strip2.setPixelColor(k, 0, 0, 0);
      }
      strip2.show();
      ...
      if (temp3 > 3) {
        ...
        for (int k = 0; k < NUMPIXELS3; k++) strip3.setPixelColor(k, 0, 0, 0);
      }
      strip3.show();
      ...
      if (temp4 > 3) {
        ...
        for (int k = 0; k < NUMPIXELS4; k++) strip4.setPixelColor(k, 0, 0, 0);
      }
      strip4.show();
      ...
      if (temp5 > 3) {
        ...
        for (int k = 0; k < NUMPIXELS5; k++) strip5.setPixelColor(k, 0, 0, 0);
      }
      strip5.show();
      delay(100);
    }
  ...
  if (temp1 > 5 && temp2 > 5 && temp3 > 5 && temp4 > 5 && temp5 > 5 && flag_end == 0) {
    for (int i = 0; i < NUMPIXELS1; i++) {
      strip1.setPixelColor(i, 0, 0, 0);
      strip2.setPixelColor(i, 0, 0, 0);
      strip3.setPixelColor(i, 0, 0, 0);
